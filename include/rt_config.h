...
//function changed in linux 2.6.35
#define usb_buffer_alloc(pUsb_Dev, BufSize, GFP_ATOMIC, pDma_addr) usb_alloc_coherent(pUsb_Dev, BufSize, GFP_ATOMIC, pDma_addr)

#define usb_buffer_free(pUsb_Dev, BufSize, pTransferBuf, Dma_addr) usb_free_coherent(pUsb_Dev, BufSize, pTransferBuf, Dma_addr)
